...
from Case.p1_PurchasePlanApply_Case import PurchaseApply_Case
...
class PurchaseApply_Test_Case(unittest.TestCase):
    ...
    def test_purchaseplanapply(self):
        ...
        try:
            ...
            pplanapply.set_username(Data.l1_Login_Data.username())
            pplanapply.set_password(Data.l1_Login_Data.password())
